...
#define TSK_ACTIVE_MM 1896 /* offsetof(struct task_struct, active_mm) */
...
#define TSK_STACK_CANARY 2016 /* offsetof(struct task_struct, stack_canary) */

#define THREAD_CPU_CONTEXT 7520 /* offsetof(struct task_struct, thread.cpu_context) */
#define THREAD_SCTLR_USER 8608 /* offsetof(struct task_struct, thread.sctlr_user) */
#define THREAD_KEYS_USER 8504 /* offsetof(struct task_struct, thread.keys_user) */
#define THREAD_KEYS_KERNEL 8584 /* offsetof(struct task_struct, thread.keys_kernel) */
#define THREAD_MTE_CTRL 8600 /* offsetof(struct task_struct, thread.mte_ctrl) */
...
#define MM_CONTEXT_ID 888 /* offsetof(struct mm_struct, context.id.counter) */
...
#define VCPU_FAULT_DISR 2392 /* offsetof(struct kvm_vcpu, arch.fault.disr_el1) */
#define VCPU_HCR_EL2 2336 /* offsetof(struct kvm_vcpu, arch.hcr_el2) */
...
#define HOST_CONTEXT_VCPU 2056 /* offsetof(struct kvm_cpu_context, __hyp_running_vcpu) */
...
#define TRAMP_VALIAS -1099549540352 /* TRAMP_VALIAS */
