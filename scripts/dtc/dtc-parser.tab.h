...
# define YYTOKENTYPE
  enum yytokentype
  {
    ...
    DT_FP_LITERAL = 275,           /* DT_FP_LITERAL  */
    DT_CHAR_LITERAL = 276,         /* DT_CHAR_LITERAL  */
    DT_BYTE = 277,                 /* DT_BYTE  */
    DT_STRING = 278,               /* DT_STRING  */
    DT_LABEL = 279,                /* DT_LABEL  */
    DT_LABEL_REF = 280,            /* DT_LABEL_REF  */
    DT_PATH_REF = 281,             /* DT_PATH_REF  */
    DT_INCBIN = 282                /* DT_INCBIN  */
  };
